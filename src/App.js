...
const useStyles = makeStyles(theme => ({
  root: {
    "& > *": {
      background: "#E0E4EB",
      boxShadow:
        " inset 9px 9px 16px #A3B1C6, inset -9px -9px 16px rgba(255, 255, 255, 0.25)",
      borderRadius: "10px",
      border: "none",
      width: "100%",
      height: "75px"
  ...
  return (
    <Container className={classes.SalimContainer}>
      <Grid container justify="center">
        <SalimHeader color="#A51931">ซ</SalimHeader>
        <SalimHeader color="#F4F5F8">า</SalimHeader>
        <SalimHeader color="#2D2A4A">ห</SalimHeader>
        <SalimHeader color="#F4F5F8">ริ่</SalimHeader>
        <SalimHeader color="#A51931">ม</SalimHeader>
      </Grid>
      <form>
